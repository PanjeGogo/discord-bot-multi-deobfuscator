"""Luraph-specific static analysis engine.

Non-executing: only bounded source rewrites and VM-shape observations.
"""
...
def analyze_and_rewrite(source: str, max_steps: int = 4) -> LocalResult:
    cur = source
    notes = []
